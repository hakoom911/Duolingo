...
import { SignInButton, SignedIn, SignedOut, ClerkLoading, ClerkLoaded } from "@clerk/nextjs";
...
export default function Home(){
    return <div className="max-w-[988px] mx-auto flex-1 w-full flex flex-col lg:flex-row items-center justify-center p-4 gap-2">
        ...
        <div className="flex flex-col items-center gap-y-8">
                <h1 className="text-xl lg:text-3xl font-bold text-neutral-600 max-w-[480px] text-center">Learn, practice, and master new langauges with Lingo</h1>
